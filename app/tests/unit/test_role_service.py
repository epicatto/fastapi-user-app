...
class TestRoleService:
    ...
    def test_create(self, mocker):
        ...
        mocked_get_all = mocker.patch.object(RoleRepository, 'get_by_name', return_value=None)
    ...
    def test_create_name_already_exists(self, mocker):
        ...
        mocked_get_all = mocker.patch.object(RoleRepository, 'get_by_name', return_value=role1)
    ...
    def test_update(self, mocker):
        ...
        mocked_get_all = mocker.patch.object(RoleRepository, 'get_by_id', return_value=role1)
        mocked_get_by_name = mocker.patch.object(RoleRepository, 'get_by_name', return_value=role1)
    ...
    def test_update_name_already_exists(self, mocker):
        ...
        mocked_get_all = mocker.patch.object(RoleRepository, 'get_by_id', return_value=role1)
        mocked_get_by_name = mocker.patch.object(RoleRepository, 'get_by_name', return_value=role2)
        mocked_update = mocker.patch.object(RoleRepository, 'update')
    ...
    def test_add_rights(self, mocker):
        ...
        mocked_get_role = mocker.patch.object(RoleRepository, 'get_by_id', return_value=role1)
        mocked_get_rights = mocker.patch.object(RightRepository, 'get_by_id', side_effect=[right1, right2])
        ...
        mocked_get_rights.assert_has_calls([
            call(mock.ANY, right1.id),
            call(mock.ANY, right2.id)
        ])
        mocked_add_rights.assert_called_with(mock.ANY, role1, [right1, right2])
        assert result
    ...
    def test_add_rights_role_does_not_exist(self, mocker):
        ...
        mocked_get_role = mocker.patch.object(RoleRepository, 'get_by_id', return_value=None)
        mocked_get_rights = mocker.patch.object(RightRepository, 'get_by_id', side_effect=[right1, right2])
        mocked_add_rights = mocker.patch.object(RoleRepository, 'add_rights', return_value=role1)
    ...
    def test_add_rights_right_does_not_exist(self, mocker):
        ...
        mocked_get_role = mocker.patch.object(RoleRepository, 'get_by_id', return_value=role1)
        mocked_get_rights = mocker.patch.object(RightRepository, 'get_by_id', side_effect=[right1, None])
        mocked_add_rights = mocker.patch.object(RoleRepository, 'add_rights', return_value=role1)
    ...
    def test_remove_rights(self, mocker):
        ...
        mocked_remove_rights.assert_called_with(mock.ANY, role1, [right1, right2])
        assert result
